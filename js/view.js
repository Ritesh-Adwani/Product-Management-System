          ...
          <form class="product-update-form" autocomplete="off">
            <div class="row container-fluid py-3 mx-0">
              <div class="col-md-6 mt-md-5 mt-3">
                ...
                <input type="text" class="form-control" id="productid" value=${productItems[index].id} placeholder="Product ID" inputmode="numeric" pattern="[0-9]*"/>
              </div>

              <div class="col-md-6 mt-md-5 mt-3">
                <label for="product-name" class="form-label">Product Name</label>
                <input type="text" class="form-control" id="product-name" value=${productItems[index].name} placeholder="Enter Product Name" />
              </div>

              <div class="col-md-6 mt-md-5 mt-3">
                <label for="productprice" class="form-label">Product Price</label>
                <input class="form-control" type="text" id="productprice" value=${productItems[index].price} placeholder="Enter Product Price in ₹" inputmode="numeric" pattern="[0-9]*"/>
              </div>
              ...
              <div class="col-md-6 mt-md-5 mt-3">
                ...
                <textarea class="form-control" id="product-description" value=${productItems[index].description} rows="4" placeholder="Enter Product Description"></textarea>
              </div>
              ...
              <div class="col-md-6 mt-md-5 mt-3">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <img src=${productItems[index].img} id="img-preview" class="d-block mx-auto" height="110px">
                  </div>
                </div>
              </div>
            </div>  
